...
\institute{Universit\"at Bremen, \href{mailto:nevarez@item.uni-bremen.de}{nevarez@item.uni-bremen.de}} % Institution(s)
...
The proposed optimization technique accelerates floating-point computation. This approach accelerates computation, reduces energy consumption and resource utilization.
...
\small{\rmfamily{This work is funded by the \textit{CONACYT} (the Mexican National Council for Science and Technology).}} \\
