...
\REVIEW{The SbS network inference is described in Algorithm\mbox{~\ref{alg:inference}}, while spike production and layer update are described in Algorithm\mbox{~\ref{alg:spike}} and \mbox{~\ref{alg:update}}, respectably.}
